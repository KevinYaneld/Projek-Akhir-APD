...
def update_inventory():
    if len(inventory_list[0]) > 0:
        while True:
            ...
            print(tabulate({'Nama': inventory_list[0], 'Stock': inventory_list[1], 'Harga Beli': inventory_list[2],'Harga Jual':inventory_list[3]}, headers="keys", tablefmt='fancy_grid', showindex = range(1,length)))
            try:
...
def create_order():
    while True:
        try:
            length = len(inventory_list[0]) + 1
            print(tabulate({'Nama': inventory_list[0], 'Stock': inventory_list[1],'Harga':inventory_list[3]}, headers="keys", tablefmt='fancy_grid', showindex = range(1,length)))
